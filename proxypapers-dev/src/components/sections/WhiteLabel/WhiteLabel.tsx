...
// top over concentric dashed/solid rings around a YOU core. The reveal mechanic is the
// Trust section's (see useWhiteLabel). LIGHT surface (navbar flips light).
    ...
    >
      <div className={s.panel}>
        ...
        <div className={s.stage}>
          ...
          {/* Radar graphic — P-badge over concentric rings around the YOU core. */}
